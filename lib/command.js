...
(function() {
  ...
  preprocessArgs = function(args) {
    var arg, char, i, j, len, len1, match, ref, result;
    result = [];
  ...
  parseOptions = function(args) {
    var arg, i, len, option, options, ref;
    options = {
      files: [],
      identifier: "ecoTemplates"
    };
    option = null;
    ref = preprocessArgs(args);
  ...
  each = function(arg1, callback) {
    var proceed, values;
    values = 1 <= arg1.length ? slice.call(arg1, 0) : [];
